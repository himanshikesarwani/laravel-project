...
trait EntrustRoleTrait
{
    ...
    {
        return $this->belongsToMany(Config::get('entrust.model'), Config::get('entrust.role_user_table'),Config::get('entrust.role_foreign_key'),Config::get('entrust.user_foreign_key'));
       // return $this->belongsToMany(Config::get('entrust.model'), Config::get('entrust.role_user_table'));
    }
